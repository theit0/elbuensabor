                                ...
                                authRequest
                                      ...
                                      //  .requestMatchers("/api/v1/ArticuloManufacturado/**").permitAll()
                                       // .requestMatchers(HttpMethod.GET,"/api/v1/ArticuloManufacturado").permitAll()
                                        .requestMatchers(HttpMethod.GET,"/api/v1/ArticuloManufacturado/filtradoPorPrecioDesc").hasAuthority("CLI")                                        .requestMatchers("/api/v1/ArticuloManufacturado/filtradoPorPrecioAsc").permitAll()
