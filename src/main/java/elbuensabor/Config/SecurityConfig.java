        ...
        return http
                ...
                .authorizeHttpRequests(authRequest ->
                                authRequest
                                        ...
                                        .requestMatchers(HttpMethod.GET,"/api/v1/clientes/").hasAuthority("ADMINISTRADOR")
                                      //  .requestMatchers("/api/v1/ArticuloManufacturado/**").permitAll()
                                       // .requestMatchers(HttpMethod.GET,"/api/v1/ArticuloManufacturado").permitAll()
                                        .requestMatchers(HttpMethod.GET,"/api/v1/ArticuloManufacturado/filtradoPorPrecioDesc/").hasAuthority("CLIENTE")                                        .requestMatchers("/api/v1/ArticuloManufacturado/filtradoPorPrecioAsc").permitAll()
